<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
  <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
    <div>
      <img src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&amp;fit=crop&amp;q=80&amp;w=1160" alt="" class="aspect-video rounded-lg object-cover">
      ...
      <div class="mt-4 flex items-center justify-between gap-4">
        ...
        <a href="#" target="_blank" rel="noreferrer" class="text-[#0072b1] transition-opacity hover:opacity-90">
